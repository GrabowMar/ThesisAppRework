...
Comprehensive documentation for analysis tools used in the ThesisApp analyzer services. This document covers all tools integrated into the static, dynamic, performance, and AI analyzer services.
...
### OpenRouter API (AI Code Analysis)
...
#### Description
OpenRouter provides access to multiple AI models for code analysis, including models from Anthropic, OpenAI, Google, and others. It's used for intelligent code review and suggestions.
...
- **System prompts**: Custom analysis instructions
- **Reasoning**: Enable step-by-step analysis
...
```python
prompt = """
Please analyze this web application codebase:
...
```json
{
  "status": "success",
  "model": "anthropic/claude-3-haiku",
  "analysis": "## Security Analysis\n\n**Critical Issue: SQL Injection Vulnerability**\nThe code in `app.py` line 7 contains a direct SQL injection vulnerability...",
  "usage": {
    "input_tokens": 245,
    "output_tokens": 1823,
    "total_tokens": 2068
