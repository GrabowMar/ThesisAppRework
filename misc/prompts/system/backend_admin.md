...
- Implement standard admin patterns:
  1. GET /admin/items - List ALL items (including inactive)
  2. POST /admin/items/{id}/toggle - Toggle active status
  3. POST /admin/items/bulk-delete - Delete multiple items
  4. GET /admin/stats - Dashboard statistics
