...
class ContainerizedTest(db.Model):
    ...
    def set_tools_used(self, tools_list: list[str] | None) -> None:
    ...
    def set_result_data(self, data_dict: dict[str, Any] | None) -> None:
...
class BatchJob(db.Model):
    ...
    def get_primary_model(self) -> str | None:
        """Get the first model from the models list."""
        models = self.get_models()
        return models[0] if models else None

    def get_primary_app_num(self) -> int | None:
