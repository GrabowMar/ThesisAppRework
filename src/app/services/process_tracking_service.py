...
class ProcessTrackingService:
    ...
    def register_process(service_name: str, service_type: str = 'main', 
                        process_id: int = None, host: str = None, 
                        port: int = None, command_line: str = None,
                        metadata: Dict[str, Any] = None) -> Optional[ProcessTracking]:
        """
        ...
        try:
            ...
            if existing:
                ...
                if metadata:
                    tracking.set_metadata(metadata)
    ...
    def update_heartbeat(service_name: str, service_type: str = 'main', 
                        resource_usage: Dict[str, Any] = None) -> bool:
        """
        ...
        try:
            ...
            if process:
                process.last_heartbeat = datetime.now(timezone.utc)
                if resource_usage:
                    process.resource_usage = resource_usage
