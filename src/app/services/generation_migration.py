...
def run_generated_migration(delete_source: bool = False) -> Dict[str, Any]:
    """Migrate legacy folders into `src/generated`.

    Legacy patterns handled:
      - project_root/generated/* (old root) -> src/generated/apps/<model>
      - project_root/api_data/* -> src/generated/{raw_api|stats|failures}
    """
