...
def statistics_overview():
    ...
    try:
        ...
        # Render using the new standardized statistics wrapper
...
def statistics_generation():
    ...
    try:
        ...
        return render_template('pages/statistics/statistics_main.html', page_title='Error', main_partial='ui/elements/common/error.html', error=str(e)), 500
