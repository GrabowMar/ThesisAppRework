...
class User(UserMixin, db.Model):
    ...
    def get_api_rate_limit(self) -> int:
        ...
        limits = {"user": 100, "researcher": 1000, "admin": 10000}
...
class SessionToken(db.Model):
    ...
    user = db.relationship(
        "User",
        backref=db.backref("session_tokens", lazy=True, cascade="all, delete-orphan"),
    )

    def __init__(
        self, user_id: int, name: str = None, expires_days: int = 30, **permissions
    ):
