...
# Legacy imports that tests and other modules might expect
statistics_bp = None  # Will be created during blueprint registration
testing_bp = None     # Will be created during blueprint registration
analysis_bp = None    # Will be created during blueprint registration
batch_bp = None       # Will be created during blueprint registration
files_bp = None       # Will be created during blueprint registration
