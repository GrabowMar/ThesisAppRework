#!/usr/bin/env python3
"""
Debug test for analysis_engines import issue in Celery context
"""

import os
import sys

# Set up the same path context as worker.py
...
try:
    ...
    import traceback
    traceback.print_exc()
    print(f"This would cause get_engine = None in tasks.py")
