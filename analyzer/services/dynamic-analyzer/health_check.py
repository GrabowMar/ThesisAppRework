#!/usr/bin/env python3
"""
Health Check for Dynamic Analyzer Service
=========================================

This script performs a health check on the Dynamic Analyzer WebSocket service.

The health check:
- Connects to the Dynamic Analyzer service on the configured WebSocket port (default: 2002)
...
scripts to verify the Dynamic Analyzer service is running correctly.
"""
