#!/usr/bin/env python3
"""
Performance Tester Service - Simple WebSocket Server
====================================================

A simple performance testing service that responds to health checks and ping messages.
This service listens on port 2003 and can be extended to perform actual performance testing.
...
class PerformanceTester:
    """Simple performance tester service."""
    ...
    async def handle_message(self, websocket, message_data):
        ...
        try:
            ...
            if msg_type == "ping":
                ...
                # Simple performance test response
                ...
                await websocket.send(json.dumps(response))
                logger.info(f"Completed performance test for {model_slug} app {app_number}")
